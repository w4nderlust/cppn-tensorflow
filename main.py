...
if __name__ == '__main__':
    ...
    ########## Test RPNN ##########
    # sampler = Sampler(model_type='RPPN', z_dim=4, c_dim=3, scale=8.0, net_size=32)
    ...
    #                   duration2=1.0, duration=0.1, x_dim=256, y_dim=256, scale=10.0, k1=0, k2=24, reverse=True)

    ########## Test mp4 with different number of repetitions ##########
    # z1 = sampler.generate_z()
    # sampler.save_anim_mp4(z1, z1, 'anim_k0_k24_256.mp4', n_frame=24, fps=24, x_dim=256, y_dim=256, scale=10.0, k1=0, k2=24)